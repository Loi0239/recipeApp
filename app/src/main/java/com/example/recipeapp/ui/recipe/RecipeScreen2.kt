...
//            Spacer(modifier = Modifier.padding(top = 20.dp))
//            Column {
//                Producer(step = "Bước 1", des = "Lorem Ipsum tempor incididunt ut labore et dolore,in voluptate velit esse cillum dolore eu fugiat nulla pariatur?")
//            }
//        }
//
//    }
...
//                Text(text = step,Modifier.padding(20.dp),
//                    fontWeight = FontWeight(weight = 1000),
//                    style = MaterialTheme.typography.titleMedium,)
//            }
//            Row(modifier = Modifier.fillMaxWidth()) {
//                Text(text = des, Modifier.padding(start = 20.dp, end = 20.dp, bottom = 20.dp).alpha(0.3f),
//                    fontWeight = FontWeight(weight = 1000),
